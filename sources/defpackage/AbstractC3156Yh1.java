...
public abstract /* synthetic */ class AbstractC3156Yh1 {
    ...
    static {
        ...
        a = iArr;
        try {
            iArr[ContentMode.CONTENT_MODE_SCALE_ASPECT_FIT.ordinal()] = 1;
        } catch (NoSuchFieldError unused) {
        }
        try {
            a[ContentMode.CONTENT_MODE_SCALE_ASPECT_FILL.ordinal()] = 2;
        } catch (NoSuchFieldError unused2) {
        }
        try {
            a[ContentMode.CONTENT_MODE_CENTER.ordinal()] = 3;
