...
public final class C10175tn0 extends AbstractC7094ko3 {
    ...
    public C10175tn0(int i) {
        super(24);
    }

    public static C10175tn0 d(C8697pU1 c8697pU1) {
        C1730Ni0 a = AbstractC7902n9.a(c8697pU1);
        try {
            C10175tn0 c10175tn0 = new C10175tn0(a.c(d).b);
            c10175tn0.b = a.o(8);
            C1730Ni0 s = a.s(16, false);
            int i = s.j(-1).b;
            c10175tn0.c = new C5874hF2[i];
            for (int i2 = 0; i2 < i; i2++) {
                c10175tn0.c[i2] = C5874hF2.d(AbstractC7558m9.a(i2, 8, 8, s, false));
            }
            return c10175tn0;
        } finally {
            a.a();
