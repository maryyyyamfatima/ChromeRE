...
public final class SM implements Runnable {
    ...
    public SM(VM vm, Wrappers$BluetoothGattCharacteristicWrapper wrappers$BluetoothGattCharacteristicWrapper, int i) {
        this.h = vm;
    ...
    public final void run() {
        ...
        AbstractC4851eH1.d("Bluetooth", "onCharacteristicWrite status:%d==%s", objArr);
