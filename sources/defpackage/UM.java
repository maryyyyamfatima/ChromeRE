...
public final class UM implements Runnable {
    ...
    public UM(VM vm, Wrappers$BluetoothGattDescriptorWrapper wrappers$BluetoothGattDescriptorWrapper, int i) {
        this.h = vm;
    ...
    public final void run() {
        ...
        AbstractC4851eH1.d("Bluetooth", "onDescriptorWrite status:%d==%s", objArr);
