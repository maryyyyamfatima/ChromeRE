...
public final class C1923Ou3 implements InterfaceC8876pz3 {
    ...
    public final void Z(Tab tab) {
        int id = tab.getId();
        C2183Qu3.d().edit().remove(id + "_url").remove(C2183Qu3.g(id)).remove(C2183Qu3.f(id)).remove(C2183Qu3.c(id)).remove(C2183Qu3.e(id)).remove(C2183Qu3.b(id)).apply();
    }
}
