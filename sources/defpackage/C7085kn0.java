...
public final class C7085kn0 extends AbstractC7094ko3 {
    ...
    public C7085kn0(int i) {
        super(16);
    }

    public static C7085kn0 d(C8697pU1 c8697pU1) {
        C1730Ni0 a = AbstractC7902n9.a(c8697pU1);
        try {
            C7085kn0 c7085kn0 = new C7085kn0(a.c(c).b);
            C1730Ni0 s = a.s(8, false);
            int i = s.j(-1).b;
            c7085kn0.b = new String[i];
            for (int i2 = 0; i2 < i; i2++) {
                c7085kn0.b[i2] = AbstractC7214l9.a(i2, 8, 8, s, false);
            }
            return c7085kn0;
        } finally {
            a.a();
